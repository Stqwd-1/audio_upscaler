...
# 3. Losses
from losses import LSDLoss, SpectralLoss
...
print('4. QualityController: OK (n_candidates=2)')
...
print('   bandwidth_limit, quantization_noise, mp3_artifacts')
...
print('7. Optuna Tuning: module loaded')

# 8. Web UI (separate venv)
print('8. Gradio Web UI: web_app.py (requires gradio venv)')
